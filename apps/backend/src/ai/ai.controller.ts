    ...
    return [
      {
        id: 'ins-1',
        type: 'SAVING',
        title: 'Battery Dispatch Optimization',
        description:
          'Shifting 2.1 kWh of evening load to battery discharge window could save NGN 8,200/month.',
        impact: 'HIGH',
        savings: 8200,
        currency: 'NGN',
        actionable: true,
      ...
      },
      {
        ...
        description:
          'Inverter efficiency dropped from 97.4% to 95.1% in 7 days. Possible MPPT mismatch.',
        impact: 'MEDIUM',
        actionable: true,
        timestamp: new Date().toISOString(),
      },
      {
        ...
        description: 'Soiling loss at 6.3%. Recommend cleaning within 5 days.',
        impact: 'MEDIUM',
        savings: 3400,
        currency: 'NGN',
        actionable: true,
      ...
      },
      {
        id: 'ins-4',
        type: 'OPTIMIZATION',
        title: 'P2P Trade Opportunity',
        description:
          '3 active buyers. Surplus: 1.8 kW. Recommend listing at NGN 195/kWh.',
        impact: 'HIGH',
        savings: 5850,
        currency: 'NGN',
        actionable: true,
      ...
      },
      {
        id: 'ins-5',
        type: 'FORECAST',
        title: 'High Generation Week Ahead',
        description: 'Weather models predict +22% irradiance next week.',
        impact: 'LOW',
        actionable: false,
        timestamp: new Date().toISOString(),
      },
