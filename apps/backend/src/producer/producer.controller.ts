...
export class ProducerController {
  ...
  // ── PLANTS ─────────────────────────────────────────────────────────────────
  @Post('plants')
  @Roles(UserRole.COMMERCIAL_ENERGY_PRODUCER, UserRole.ADMIN, UserRole.SYSTEM_OWNER)
  @ApiOperation({ summary: 'Register a generating plant' })
  registerPlant(@Body() dto: RegisterPlantDto, @CurrentUser('id') userId: string) {
  ...
  createFeeder(@Body() dto: CreateFeederDto, @CurrentUser('id') operatorId: string) {
  ...
  createZone(@Body() dto: CreateZoneDto, @CurrentUser('id') operatorId: string) {
  ...
  connectConsumer(@Body() dto: ConnectConsumerDto, @CurrentUser('id') operatorId: string) {
  ...
  disconnectConsumer(@Param('id') id: string, @CurrentUser('id') operatorId: string) {
  ...
  reconnectConsumer(@Param('id') id: string, @CurrentUser('id') operatorId: string) {
  ...
  allocateEnergy(@Body() dto: AllocateEnergyDto, @CurrentUser('id') operatorId: string) {
  ...
  dispatchEnergy(@Body() dto: DispatchEnergyDto, @CurrentUser('id') operatorId: string) {
  ...
  pauseDispatch(@Param('id') id: string, @CurrentUser('id') operatorId: string) {
  ...
  resumeDispatch(@Param('id') id: string, @CurrentUser('id') operatorId: string) {
  ...
  logGridExport(@Body() dto: LogGridExportDto, @CurrentUser('id') operatorId: string) {
  ...
  @Roles(UserRole.COMMERCIAL_ENERGY_PRODUCER, UserRole.ADMIN, UserRole.SYSTEM_OWNER)
  @ApiOperation({ summary: 'Get AI forecasting and optimization recommendations' })
