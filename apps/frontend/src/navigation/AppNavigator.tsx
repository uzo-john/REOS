...
// ── Nav Items config ──────────────────────────────────────────────────────
const NAV_ITEMS = [
  { name: "Overview",    label: "Dashboard",         icon: "⚡", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "RegisterConsumerMeter", label: "Register Smart Meter", icon: "📟", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "ProducerSetupWizard", label: "Producer Setup Wizard", icon: "🏭", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "Monitoring",  label: "Live Monitoring",   icon: "📡", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "SolarDesign", label: "Solar Design",      icon: "☀️", userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
  { name: "Devices",     label: "Device Manager",    icon: "🔌", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "AIForecast",  label: "AI Forecasting",    icon: "🤖", userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
  { name: "AIChat",      label: "AI Assistant",      icon: "💬", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "Analytics",   label: "Energy Analytics",  icon: "📊", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "Billing",     label: "Billing",           icon: "💰", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "Trading",     label: "P2P Trading",       icon: "🔄", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "Admin",       label: "Admin Finance",     icon: "🏛️", userTypes: ["ADMIN"] },
  { name: "Fleet",       label: "Fleet Dashboard",   icon: "🏗️", userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
  { name: "Alarms",      label: "Alarm Center",      icon: "🚨", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  { name: "Maintenance", label: "Maintenance",       icon: "🔧", userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
  { name: "Settings",    label: "Settings",          icon: "⚙️", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
];
...
function DrawerNavigator() {
  ...
  const screensConfig = [
    { name: "Overview",    component: OverviewScreen,         title: "Dashboard",         userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "RegisterConsumerMeter", component: ConsumerMeterRegistrationScreen, title: "Register Smart Meter", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "ProducerSetupWizard", component: ProducerSetupWizardScreen, title: "Producer Setup Wizard", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "Monitoring",  component: MonitoringScreen,       title: "Live Monitoring",   userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "SolarDesign", component: SolarDesignScreen,      title: "Solar Design",      userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
    { name: "Devices",     component: DeviceManagementScreen,  title: "Device Manager",    userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "AIForecast",  component: AIForecastingScreen,     title: "AI Forecasting",    userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
    { name: "AIChat",      component: AIChatScreen,           title: "AI Assistant",      userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "Analytics",   component: AnalyticsScreen,        title: "Energy Analytics",  userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "Billing",     component: BillingScreen,          title: "Billing",           userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "Trading",     component: TradingScreen,          title: "P2P Energy Trading", userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "Admin",       component: AdminScreen,            title: "Admin Finance Centre", userTypes: ["ADMIN"] },
    { name: "Fleet",       component: FleetScreen,            title: "Fleet Dashboard",   userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
    { name: "Alarms",      component: AlarmScreen,            title: "Alarm Center",      userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
    { name: "Maintenance", component: MaintenanceScreen,      title: "Maintenance",       userTypes: ["PROSUMER", "PRODUCER", "ADMIN"] },
    { name: "Settings",    component: SettingsScreen,         title: "Settings",          userTypes: ["PROSUMER", "CONSUMER", "PRODUCER", "ADMIN"] },
  ];
